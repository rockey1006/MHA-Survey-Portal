...
class UpdateEvidenceQuestionText < ActiveRecord::Migration[7.1]
  OLD_TEXT = "Please provide a Google Drive or Google Sites link as evidence for this survey."
  NEW_TEXT = "Please provide a link to your (Google Drive) MHA Portfolio as evidence for this survey."
