...
class QuestionsController < ApplicationController
  ...
  def question_params
    ...
    params.require(:question).permit(:category_id, :question_order, :question_type, :question_text, :description, :tooltip_text, :answer_options, :is_required, :has_evidence_field)
  end
end
